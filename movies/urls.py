...
urlpatterns = [
    ...
    path('requests/delete/<int:request_id>/', views.delete_request, name='movies.delete_request'),
    ...
    path('petitions/<int:pk>/vote/', views.petition_vote, name='movies.petition_vote'),
]